    ...
    <section className="relative z-10 min-h-screen flex items-center py-8 lg:py-16" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              {timelineData.map((item, index) => (
                ...
                >
                  ...
                  {/* Timeline Content */}
                  <div className="flex-grow backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl">
                    ...
                    <div className="relative z-10">
                      <div className={`text-lg font-bold bg-gradient-to-r ${item.dotColor} bg-clip-text text-transparent mb-2`}>
                        {item.days}
                      </div>
          ...
          <div className="hidden lg:grid lg:grid-cols-5 lg:gap-12 xl:gap-16">
            
            {/* Left Side - Timeline */}
            <div className="lg:col-span-2">
              <div className="relative">
                {/* Vertical Timeline Line */}
                <div className="absolute left-2 top-8 bottom-8 w-0.5 bg-white/20"></div>
                ...
                <div className="space-y-12">
                  {timelineData.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex-grow backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 shadow-2xl">
                        {/* Subtle inner glow */}
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/5 via-transparent to-transparent pointer-events-none"></div>
                        
                        <div className="relative z-10">
                          <div className={`text-lg lg:text-xl font-bold bg-gradient-to-r ${item.dotColor} bg-clip-text text-transparent mb-2`}>
                            {item.days}
                          </div>
            ...
            <div className="lg:col-span-3 lg:flex lg:flex-col lg:justify-center">
              <motion.div
                className="space-y-8"
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                {/* Additional Context */}
                <motion.div
                  className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 shadow-2xl"
